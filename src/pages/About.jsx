      ...
      <main>
        ...
        <section className="relative bg-deep pt-40 pb-24 lg:pt-48 lg:pb-32 overflow-hidden border-b border-accent/10">
          <div className="absolute inset-0 z-0 bg-[#F5F0E8] pointer-events-none">
            <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=2000" alt="About Background" className="w-full h-full object-cover opacity-[0.45] mix-blend-normal" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 w-full">
            ...
            >
              ...
              <span className="hero-italic-line italic font-normal normal-case">driven by efficiency.</span>
            </motion.h1>
